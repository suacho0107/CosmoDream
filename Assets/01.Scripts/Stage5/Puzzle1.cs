...
public class Puzzle1 : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    [SerializeField]
    ...
    void Update()
    {
        ...
        {
            // 목표 오브젝트의 위치가 변경된 경우, 퍼즐 조각을 목표 오브젝트의 위치에 맞춘다.
            Vector3 targetPosition = targetObject.GetComponent<RectTransform>().position;
            rectTransform.position = targetPosition;
        }
    }
